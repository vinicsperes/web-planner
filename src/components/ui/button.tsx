...
/* Sem forwardRef, o ref aponta para o React Component, não para o <button>, impedindo de abrir a Dialog */
export const ButtonIcon = React.forwardRef<HTMLButtonElement, React.ButtonHTMLAttributes<HTMLButtonElement>>(
  (props, ref) => {
    return (
